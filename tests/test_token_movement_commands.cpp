...
TEST_CASE("command_forward_up_token_pair_or_indent") {
    cz::Str body =
        "\n\
|class| Class:\n\
  |def f():\n\
...
|def h():|";
    ...
    for (size_t i = 0; i < cursors.len; ++i) {
        ...
        tr.run(command_forward_up_token_pair_or_indent);
        ...
        case 7:  // |
        case 8:  //     sup|
            CHECK(dest == cursors[8].point + 1);
            break;
        case 3:  //     |pass
        case 4:  //     pa|ss
            CHECK(dest == cursors[4].point + 3);
            break;
        case 6:  //   def g(|):
            CHECK(dest == cursors[6].point + 1);
            break;
