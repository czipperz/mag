...
void forward_visible_line(const Window*, const Mode&, Contents_Iterator*, uint64_t rows = 1);
void backward_visible_line(const Window*, const Mode&, Contents_Iterator*, uint64_t rows = 1);
