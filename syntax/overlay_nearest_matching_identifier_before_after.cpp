#include "overlay_nearest_matching_identifier_before_after.hpp"
...
namespace overlay_nearest_matching_identifier_before_after_impl {
struct Data {
    Face face;
...
static void overlay_nearest_matching_identifier_before_after_start_frame(Editor* editor,
                                                                         Client* client,
                                                                         const Buffer* buffer,
    ...
    if (basic::find_nearest_matching_identifier_before_after(start, middle, end.position,
                                                             /*max_buckets=*/5, &it)) {
...
Overlay overlay_nearest_matching_identifier_before_after(Face face) {
